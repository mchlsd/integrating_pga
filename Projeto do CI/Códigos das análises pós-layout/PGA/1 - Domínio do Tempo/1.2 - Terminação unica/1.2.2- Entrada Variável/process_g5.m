...
Va_time = [table2array(seg518180(2:end,1:2:14))];
Va_data = [table2array(seg518180(2:end,2:2:14))];

Vout_time = [table2array(seg518180(2:end,15:2:28))];
Vout_data = [table2array(seg518180(2:end,16:2:28))];

Vcs_time = [table2array(seg518180(2:end,29:2:42))];
Vcs_data = [table2array(seg518180(2:end,30:2:42))];
...
%set(gcf,'Resize','off')
pause
exportgraphics(gcf,'G5_se.pdf','ContentType','vector')
...
pause
exportgraphics(gcf,'Vo_G5_se.pdf','ContentType','vector')
