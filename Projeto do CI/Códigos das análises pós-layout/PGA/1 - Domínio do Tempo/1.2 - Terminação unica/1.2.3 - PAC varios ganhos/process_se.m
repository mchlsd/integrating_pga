...
gain_frequency = table2array(se_bode(:,1:4:20));
gain_data = table2array(se_bode(:,2:4:20));

phase_frequency = table2array(se_bode(:,3:4:20));
phase_data = table2array(se_bode(:,4:4:20));
...
pause
exportgraphics(gcf,'PGA_freq_se.pdf','ContentType','vector')
