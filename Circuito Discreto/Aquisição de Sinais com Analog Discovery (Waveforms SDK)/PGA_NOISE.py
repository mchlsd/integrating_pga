...
dwf.FDwfAnalogOutFunctionSet(hdwf, c_int(0), funcNoise)

dwf.FDwfAnalogOutOffsetSet(hdwf, c_int(0), c_double(vip))
dwf.FDwfAnalogOutAmplitudeSet(hdwf, c_int(0), c_double(1.68e-3))
dwf.FDwfAnalogOutFrequencySet(hdwf, c_int(0), c_double(1e4))
...
#################### Acquisition ########################
#########################################################
for k in range(325, int(param)+5, 5):
