...
gain_temperature = table2array(PGAG21cornerstemperature(:,1:2:12));
gain_data = table2array(PGAG21cornerstemperature(:,2:2:12));
...
figure (1)
plot(gain_temperature,gain_data,'LineWidth',2);
%title('\fontsize{15}{0} Ganho','Interpreter','Latex');
...
pause
exportgraphics(gcf,'PGA_corners_g21_temperature.pdf','ContentType','vector')
