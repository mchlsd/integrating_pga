...
% h = figure
% plot(AOL, (mGslope-(po(1))/po(1))*100,'LineWidth',1.5,'color','k')
% xlabel('{\it A_{OL}} (dB)')
...
% 
% h = figure
% plot(AOL,sGslope,'LineWidth',1.5,'color','k')
% xlabel('{\it A_{OL}} (dB)')
% ylabel('Gain uncertainty (V/V)')
% xlim([45 120])
% grid
...
% 
% h = figure
% plot(AOL, (mGoffset - mvcs)*1e3,'LineWidth',1.5,'color','k')
% xlabel('{\it A_{OL}} (dB)')
% ylabel('Mean Offset (mV)')
% xlim([45 120])
% grid
% set_fig_position(h,421,0,420,560)
% 
% h = figure
% plot(AOL,sGoffset*1e3,'LineWidth',1.5,'color','k')
% xlabel('{\it A_{OL}} (dB)')
% ylabel('Offset uncertainty (mV)')
% xlim([45 120])
% grid
