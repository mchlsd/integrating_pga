...
load ('se_gain_i.mat');
load ('se_gain_i_20.mat');

Va_time = [table2array(se65mvinterpol(2:end,1:2:16)) table2array(se65mv20u(2:end,1)) table2array(se65mvinterpol(2:end,17))];
Va_data = [table2array(se65mvinterpol(2:end,2:2:16)) table2array(se65mv20u(2:end,2)) table2array(se65mvinterpol(2:end,18))];

Vout_time = [table2array(se65mvinterpol(2:end,19:2:34)) table2array(se65mv20u(2:end,3)) table2array(se65mvinterpol(2:end,35))];
Vout_data = [table2array(se65mvinterpol(2:end,20:2:34)) table2array(se65mv20u(2:end,4)) table2array(se65mvinterpol(2:end,36))];

Vcs_time = [table2array(se65mvinterpol(2:end,37:2:52)) table2array(se65mv20u(2:end,5)) table2array(se65mvinterpol(2:end,53))];
Vcs_data = [table2array(se65mvinterpol(2:end,38:2:52)) table2array(se65mv20u(2:end,6)) table2array(se65mvinterpol(2:end,54))];
