...
for ix=1:length(v_teta)
    ...
    for iy=1:num_of_sim
        ...
        tline{i_ra} = sprintf('TEXT -584 984 Left 2 !.param ra = %fk',normrnd(ra,sra));
        tline{i_cs} = sprintf('TEXT -584 1016 Left 2 !.param cs = %fn',normrnd(cs,scs));
        tline{i_ca} = sprintf('TEXT -584 1048 Left 2 !.param ca = %fn',normrnd(ca,sca));
        tline{i_co} = sprintf('TEXT -584 1072 Left 2 !.param co = %fn',normrnd(co,sco));
