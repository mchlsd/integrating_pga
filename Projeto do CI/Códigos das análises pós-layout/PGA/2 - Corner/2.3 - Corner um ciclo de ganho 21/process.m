...
Va_time = [table2array(CornerG2165mv(2:end,1:2:10))];
Va_data = [table2array(CornerG2165mv(2:end,2:2:10))];

Vout_time = [table2array(CornerG2165mv(2:end,11:2:20))];
Vout_data = [table2array(CornerG2165mv(2:end,12:2:20))];

Vcs_time = [table2array(CornerG2165mv(2:end,21:2:30))];
Vcs_data = [table2array(CornerG2165mv(2:end,22:2:30))];
...
plot(Va_time(:,5)*1e6,Va_data(:,5),'-',Vout_time(:,5)*1e6,Vout_data(:,5),'--','LineWidth',1.5);
plot(Vcs_time(:,5)*1e6,Vcs_data(:,5),'-.','LineWidth',1.5);
hold off
