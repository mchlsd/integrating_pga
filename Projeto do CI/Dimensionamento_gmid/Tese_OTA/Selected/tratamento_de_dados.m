...
Vout_time = table2array(SelectedParametersGBW50MAOL70dBSLR25M(2:end,1));
Vout_data = table2array(SelectedParametersGBW50MAOL70dBSLR25M(2:end,2));

Va_time = table2array(SelectedParametersGBW50MAOL70dBSLR25M(2:end,3));
Va_data = table2array(SelectedParametersGBW50MAOL70dBSLR25M(2:end,4));

Vcs_time = table2array(SelectedParametersGBW50MAOL70dBSLR25M(2:end,5));
Vcs_data = table2array(SelectedParametersGBW50MAOL70dBSLR25M(2:end,6));
