...
Va_time = [table2array(seg1018180(2:end,1:2:14))];
Va_data = [table2array(seg1018180(2:end,2:2:14))];

Vout_time = [table2array(seg1018180(2:end,15:2:28))];
Vout_data = [table2array(seg1018180(2:end,16:2:28))];

Vcs_time = [table2array(seg1018180(2:end,29:2:42))];
Vcs_data = [table2array(seg1018180(2:end,30:2:42))];
...
xlabel('Tensão de Entrada(mV)','FontSize',12)
legend('Ideal','Medido')
ylim([9.5 10.5])
grid
set(gca,'FontSize',12)
...
%set(gcf,'Resize','off')
pause
exportgraphics(gcf,'G10_se.pdf','ContentType','vector')
...
%title('\fontsize{15}{0} $\overline{V_{o}}$','Interpreter','Latex');
ylabel('Tensão de Saída (mV)','FontSize',10)
xlabel('Tensão de Entrada(mV)','FontSize',10)
legend('Ideal', 'Medido')
grid
set(gca,'FontSize',12)
set(gcf, 'Position',  [522, 1920, 523, 422])
pause
exportgraphics(gcf,'Vo_G10_se.pdf','ContentType','vector')
