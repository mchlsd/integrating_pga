...
Va_time = table2array(diff65mvvariableGain2500cycles(2:end,1:2:20));
Va_data = table2array(diff65mvvariableGain2500cycles(2:end,2:2:20));

Vout_time = table2array(diff65mvvariableGain2500cycles(2:end,21:2:40));
Vout_data = table2array(diff65mvvariableGain2500cycles(2:end,22:2:40));

Vcs_time = table2array(diff65mvvariableGain2500cycles(2:end,41:2:60));
Vcs_data = table2array(diff65mvvariableGain2500cycles(2:end,42:2:60));
