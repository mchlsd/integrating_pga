...
%v_input_list = linspace(18,180,7);
...
Va_time = [table2array(diffg518180b(2:end,1:2:12)) table2array(diffg518180b(2:end,37))];
Va_data = [table2array(diffg518180b(2:end,2:2:12)) table2array(diffg518180b(2:end,38))];

Vout_time = [table2array(diffg518180b(2:end,13:2:24)) table2array(diffg518180b(2:end,39))];
Vout_data = [table2array(diffg518180b(2:end,14:2:24)) table2array(diffg518180b(2:end,40))];

Vcs_time = [table2array(diffg518180b(2:end,25:2:36)) table2array(diffg518180b(2:end,41))];
Vcs_data = [table2array(diffg518180b(2:end,26:2:36)) table2array(diffg518180b(2:end,42))];
...
%set(gcf,'Resize','off')
pause
exportgraphics(gcf,'G5_diff.pdf','ContentType','vector')
...
pause
exportgraphics(gcf,'Vo_G5_diff.pdf','ContentType','vector')
