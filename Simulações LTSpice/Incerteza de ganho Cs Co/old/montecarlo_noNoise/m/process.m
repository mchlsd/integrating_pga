...
%theta_list = [250:24:490];
theta_list = 250 + [0:20:240];
...
%G_std(end-1) = (G_std(end-2)+G_std(end))/2
%sVo2(end-1) = (sVo2(end-2)+sVo2(end))/2
...
save('monteC.mat', 'G_std', 'G_mean', 'Go', 'mVo2', 'sVo2','mVcs', 'sVcs')
